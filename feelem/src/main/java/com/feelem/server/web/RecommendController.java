...
import com.feelem.server.domain.filter.Filter; // [변경] Filter 엔티티 Import
import com.feelem.server.domain.filter.FilterService;
import com.feelem.server.global.dto.FilterSearchResponse; // [변경] 사용자 DTO Import
import com.feelem.server.recommend.HomeRecommendRequest;
import com.feelem.server.recommend.RecommendClient;
import com.feelem.server.recommend.RecommendResponse;
import com.feelem.server.recommend.SearchResponse;
